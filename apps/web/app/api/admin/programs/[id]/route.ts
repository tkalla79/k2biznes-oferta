/**
 * /api/admin/programs/[id] — PATCH (update) (sekcja 5.2 + 3.2.6).
 *
 * Brak DELETE — programy są referencowane z `offers.program_id`. Soft-disable
 * przez `is_active=false`. To zachowuje historie ofert.
 */
